|Soul -> 语言，神经网络，自然语言处理，数学，行为哲学，CS
|Gym -> Lift: 0-200
|LastMeal(1):	  22:20
...
|买球 -> 足球60分钟后买，排球18分以后买，每注利润满五毛即止，每轮都把本金买完
	-> '买前看准局'，相信实力，警惕风险边界，大概率(胜负)早买，小概率(平局)晚买
	-> 排球相差两分不稳. 分差: 5-4-3 = winA-winB-winC
	-> 重复投资不超过两次，当次投入不超过前次投入的两倍
	-> 概率 >= 1.14  1.1-1.2-1.3-1.4 = 4-3-2-1.5

-> 勿妄断未来
-> 数学是实践的产物，物质是第一性
|意志(必然性，向死而生的真谛'To Be') -> 动力(起点)->实践(技艺运用,连续性)->方向(完成)
...
|连续性 -> 同一模式的连续变化('线性变换中的变换矩阵，变换矩阵背后是连续性变化函数')
